        ...
        >
          <div className="bill-model p-3" ref={componentRef}>
            ...
            <div className="bill-customer-details my-2">
              <p>
                <b>Patient Name</b> : {selectedBill.patientName}
              </p>
              <p>
                <b>Phone Number</b> : {selectedBill.patientPhoneNumber}
              </p>
              <p>
          ...
          <div className="d-flex justify-content-end">
                  <Button type='primary' onClick={handlePrint}>Print Prescription</Button>
          </div>
        </Modal>
      )}
    </DefaultLayout>
